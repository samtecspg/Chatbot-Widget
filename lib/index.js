...
var ArticulateChatbotWidget = function (_Component) {
  ...
  _createClass(ArticulateChatbotWidget, [{
    ...
    value: function renderBotResponse(response, index) {
      ...
      var responses = [_react2.default.createElement(
        _react2.default.Fragment,
        { key: 'message_textResponse_' + index },
          ...
          case 'image':
            responses.push(_react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { target: '_blank', href: richResponse.data.image },
                  _react2.default.createElement('img', { className: 'imgcard', src: richResponse.data.image })
                )
              ),
              _react2.default.createElement('div', { className: 'clearfix' })
            ));
