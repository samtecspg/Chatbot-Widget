  ...
  _createClass(ArticulateChatbotWidget, [{
      ...
      switch (response.type) {
        ...
        default:
          if (response.quickResponses) {
            var _quickResponses = response.quickResponses;
            return _react2.default.createElement(
              _react2.default.Fragment,
              { key: 'message_' + index },
              _react2.default.createElement('img', { className: 'botAvatar', src: botAvatarImage }),
              ...
              _react2.default.createElement(
                'div',
                { className: 'quickReplies' },
                _quickResponses.map(function (quickResponse, index) {
                  return _react2.default.createElement(
                    'div',
                    { key: 'quickResponse' + index, className: 'chip', onClick: function onClick() {
                        _this3.addNewUserMessage(quickResponse);
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          name = _props4.name,
          clearItemMenuLabel = _props4.clearItemMenuLabel,
          restartItemMenuLabel = _props4.restartItemMenuLabel,
          closeItemMenuLabel = _props4.closeItemMenuLabel,
          inputPlaceholder = _props4.inputPlaceholder,
          botAvatarURL = _props4.botAvatarURL,
          userAvatarURL = _props4.userAvatarURL;
          ...
          _react2.default.createElement(
            ...
            messages.map(function (message, index) {
              return message.bot ? _this4.renderBotResponse(message.response, index) : _react2.default.createElement(
                _react2.default.Fragment,
                { key: 'message_' + index },
                _react2.default.createElement('img', { className: 'userAvatar', src: userAvatarImage }),
                _react2.default.createElement(
                  'p',
                  { className: 'userMsg' },
                  message.message
